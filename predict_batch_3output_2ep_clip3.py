...
def predict_3outpout(raw_args=None):
...
if __name__ == "__main__":
    modelpath = '/home/zhaojin/data/TacomaBridge/segdata/girder2cls_data_2ep/CP1.pth'
    inputpath = '/home/zhaojin/data/TacomaBridge/capture/high-reso-clip-2ep_rename/'
    outputpath = '/home/zhaojin/data/TacomaBridge/segdata/predict/clip3_2ep'
    runcode = ['--model', modelpath, '--input', inputpath, '--output', outputpath]
    predict_3outpout(runcode)
